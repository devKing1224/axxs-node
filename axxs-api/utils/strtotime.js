...
const reMonthText =
  "(" + reMonthFull + "|" + reMonthAbbr + "|" + reMonthroman + ")";
...
const formats = {
  ...
  backOrFrontOf: {
    regex: RegExp(
      "^(back|front) of " + reHour24 + reSpaceOpt + reMeridian + "?",
      "i"
    ),
    name: "backof | frontof",
  ...
  timeShort12: {
    regex: RegExp(
      "^" + reHour12 + "[:.]" + reMinutelz + reSpaceOpt + reMeridian,
      "i"
    ),
    name: "timeshort12",
  ...
  iso8601long: {
    regex: RegExp(
      "^t?" + reHour24 + "[:.]" + reMinute + "[:.]" + reSecond + reFrac,
      "i"
    ),
    name: "iso8601long",
  ...
  dateTextual: {
    regex: RegExp(
      "^" + reMonthText + "[ .\\t-]*" + reDay + "[,.stndrh\\t ]+" + reYear,
      "i"
    ),
    name: "datetextual",
  ...
  relative: {
    regex: RegExp(
      "^([+-]*)[ \\t]*(\\d+)" + reSpaceOpt + "(" + reReltextunit + "|week)",
      "i"
    ),
    name: "relative",
